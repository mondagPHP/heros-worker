...
class MakeServiceCommand extends AbstractCommand
{
    ...
    protected $description = '快速创建service文件';
    ...
    public function run(Input $input = null): void
    {
        ...
        $this->newByStub(function () {
            $stubFile = __DIR__ . '/stubs/service.stub';
    ...
    {
        return [
            ['-path', 'require', '以app_path()根目录开始,命名空间与路径对应 eg:app/modules/admin/service'],
            ['-class', 'require', 'service类名'],
        ];
    }
}
